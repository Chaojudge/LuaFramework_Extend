...
namespace CfgData
{
    ...
    {
        /// <summary>
        /// 读取Resouces/Cfg文件夹中指定配置表文件名的配置表
        /// </summary>
        /// <param name="cfgName">配置表文件名</param>
        /// <returns></returns>
        public static Dictionary<string, Dictionary<string, string>> LoadCfgDataFormCSV(string cfgName)
        {
            Dictionary<string, Dictionary<string, string>> dicCfgData = new Dictionary<string, Dictionary<string, string>>();
            ...
            //开始解析字符串
            ExplainString(strLine, content, out dicCfgData);
            return dicCfgData;
        }
        ...
        /// 读取指定列名指定行数的值
        /// </summary>
        /// <param name="keyName">指定列名</param>
        /// <param name="id">指定行数</param>
        /// <param name="dicCfgData">存放配置表的字典</param>
        /// <returns></returns>
        public static string ReadCfg(string keyName, int id, Dictionary<string, Dictionary<string, string>> dicCfgData)
        {
            return dicCfgData[keyName][id.ToString()];
        }
